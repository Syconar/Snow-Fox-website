window.allModalRecipes = [
{
    ...
    modInmoductions: "Mix the sugar and eggs with a whisk until combined. Then add the remaining liquid ingredients to the bowl and mix the whole mixture again. In the second bowl, prepare all the dry ingredients and then pour in the contents of the first bowl. Mix everything thoroughly but gently so the batter remains fluffy. Place 6 tall cups in a muffin tin, spray the inside with oil. Each muffin should weigh about 110g. Finally, sprinkle the individual muffins with chopped white chocolate. Bake at 175°C for 30 minutes.",
...
},
{
    ...
    modTime: "4hr",
    modMealThumb: "img/id20crèmebrûlée.jpg",
    modInmoductions: "FILL THE DIRECTIONS HERE",
...
},
{
    ...
    modTime: "30min",
    modMealThumb: "img/id13czechbacondumplings.jpg",
    modInmoductions: "FILL THE DIRECTIONS HERE",
    modIngredient1: "330g smoked pork belly",
    modIngredient2: "100g bacon, sliced and chopped",
...
},
{
    ...
    modIngredient6: "splash of Worcestershire sauce",
...
},
{
    ...
    modInmoductions: "Add all ingredients to the mixer and mix on low speed for about 3 minutes until the dough forms. Then take it out and work it with your hands for a while until it passes the stretch test. Then return the dough to the bowl and let it rise at room temperature for 1 hour. After the time has passed, take the dough out and divide it into individual pieces of about 285g each. Place them on an oiled baking sheet, wrap them in plastic wrap and let them rise at room temperature for 2 hours or put them in the refrigerator to rest at least overnight. In this case, we must take the dough out long enough before the final preparation to allow it to return to room temperature.",
...
},
{
    ...
    modIngredient3: "225g white yogurt",
...
},
{
    ...
    modTime: "20min",
    modMealThumb: "img/id5chickenburger.jpg",
    modInmoductions: "FILL THE DIRECTIONS HERE",
    modIngredient1: "2 burger buns",
...
},
{
    ...
    modInmoductions: "Mix the sugar and eggs with a whisk until combined. Then add the remaining liquid ingredients to the bowl and mix the whole mixture again. In the second bowl, prepare all the dry ingredients and then pour in the contents of the first bowl. Mix everything thoroughly but gently so the batter remains fluffy. Place 6 tall cups in a muffin tin, spray the inside with oil. Each muffin should weigh about 110g. Finally, sprinkle each muffin with raw nuts. Bake at 175°C for 30 minutes.",
    modIngredient1: "105g brown sugar",
    modIngredient2: "1 egg (medium)",
    modIngredient3: "1 egg yolk",
    modIngredient4: "20g maple syrup or honey",
    modIngredient4: "50g sunflower oil",
...
},
{
    ...
    modInmoductions: "Mix the sugar and eggs with a whisk until combined. Then add the remaining liquid ingredients to the bowl and mix the whole mixture again. In the second bowl, prepare all the dry ingredients and then pour in the contents of the first bowl. Mix everything thoroughly but gently so the batter remains fluffy. Place 6 tall cups in a muffin tin, spray the inside with oil. Each muffin should weigh about 110g. Finally, sprinkle the individual muffins with chopped chocolate. Bake at 175°C for 30 minutes.",
...
},
{
    ...
    modInmoductions: "Mix the sugar and eggs with a whisk until combined. Then add the remaining liquid ingredients to the bowl and mix the whole mixture again. In the second bowl, prepare all the dry ingredients and then pour the contents of the first bowl and sprinkle with blueberries. Mix everything thoroughly but gently so the batter remains fluffy. Place 6 tall cups in a muffin tin, spray the inside with oil. Each muffin should weigh about 110g. Finally, sprinkle each muffin with lemon sugar. Bake at 175°C for 30 minutes.",
    modIngredient1: "105g sugar",
    modIngredient2: "1 egg (medium)",
    modIngredient3: "1 egg yolk",
    modIngredient4: "75g buttermilk",
...
},
{
    ...
    modInmoductions: "First of all, we will mix the 'Tangzhong'. Into the stainless steel pot we combine milk, water and flour. Whisk that together to get it incorporated, then place that pot over medium heat and continuously whisk, until the paste thickens dramatically. This whole process should take only about 2 or 3 minutes, but be careful, because the paste starts to get thicken about 25-30 seconds. Then take 120g milk heated to about 35 degrees Celsius and add 9g of dry yeast, mix it and let that sit for about 8 minutes. Then combine in the bowl of a stand mixer 320g bread flour, 7g of salt and 35g of sugar. Give that a quick whisk unlit thouroughly incorporated. Now, with your stand mixer running on low speed, add your milk with yeast mixture. Let that run for a fex seconds and then add 'Tangzhong' paste from earlier, followed by 1 whole egg and 1 egg yolk. After that increase mixer speed to medium-low and then mix all that together untlit thoroughly incorporated. Once incorporated, gradually add 42g of softened butter, then let that stand mixer knead the dough for about 10 more minutes. Then take the dought and gently fold in the sides and then place that seam side down on a work surface and rub it around in a circle with your hands keeping constant contact with the board. Once it's into a nice ball shape, place it in oil greased bowl and let the dough slowly rise in the fridge overnight. Next day, pull the dough out and let it come back to room temperature. After that, give the dough a good old fist punch, then lightly flour a work surface and dump your dough out. using a bench scraper and scale divide your dough into six even pieces and seventh smaller one. Each piece should be around 95 to 105g. Now it's time for shaping. Grap an edge section of a dough and genttly stretch and fold it to the center, repeat that process around the whole segment of dough 5 more times, then flip it over and give it tension by pulling the dough towards you, keeping constant contact with the work surface. Repeat this process with all your dough pieces. After that, place your balls evenly spaced apart on a rimmed baking sheet tray lined with lightly greased parchment paper, each ball should be spaced apart about 6 centimeters apart. Then place another equally sized baking sheet tray inverted on top of these, so they don't dry out and allow them to rise to room temerature for one to two more hours. Preheat your oven to 190°C. Then make an egg wash consisting of one egg and a splash of milk. Whisk together nicely, then gently brush the entire top of the buns with egg wash. You can optionaly use sesame seeds for topping, then place your buns in the preheated oven for 18 minutes. After that, remove now golden buns from the oven and brush each one generously with melted butter.",
